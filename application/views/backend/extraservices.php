              ...
              <tbody>
                ...
                <?php foreach ($eslist as $es) { ?>
                  <tr>
                    ...
                    <?php } ?>
                    <td>
                      <a href="extraservices/edit/<?php echo $es['id']; ?>" title="<?php echo $lang['edit'] . ' ' . $lang['extraservice']; ?>" class="btn btn-warning btn-xs">
                        <i class="far fa-edit"></i>
                      </a>
                      <a href="JavaScript:Void(0);" onclick="return deletees('<?php echo $es['id']; ?>');" title="<?php echo $lang['delete'] . ' ' . $lang['extraservice']; ?>" class="btn btn-danger btn-xs">
                        <i class="fas fa-trash-alt"></i>
                      </a>
                      <a href="extraservices/assign/<?php echo $es['id']; ?>" title="<?php echo $lang['assign'] . ' ' . $lang['extraservice']; ?>" class="btn btn-primary btn-xs">
