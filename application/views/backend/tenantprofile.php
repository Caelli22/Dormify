        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="tab-content">
              ...
              <iframe src="<?php echo $burl; ?>admin/tenant_report/<?php echo $tenant['ten_uid']; ?>/paid_inv" frameborder="0" scrolling="no" class="ten_report_frame" style="width: 100%; height: 600px;"></iframe>
              </div>

              <div class="tab-pane" id="pendinginv">
              <iframe src="<?php echo $burl; ?>admin/tenant_report/<?php echo $tenant['ten_uid']; ?>/pen_inv" frameborder="0" scrolling="no" class="ten_report_frame" style="width: 100%; height: 600px;"></iframe>
              </div>

              <div class="tab-pane" id="allpayments">
              <iframe src="<?php echo $burl; ?>admin/tenant_report/<?php echo $tenant['ten_uid']; ?>/all_pay" frameborder="0" scrolling="no" class="ten_report_frame" style="width: 100%; height: 600px;"></iframe>
              </div>

              <div class="tab-pane" id="alles">
              <iframe src="<?php echo $burl; ?>admin/tenant_report/<?php echo $tenant['ten_uid']; ?>/all_aes" frameborder="0" scrolling="no" class="ten_report_frame" style="width: 100%; height: 600px;"></iframe>
              </div>
