...
<div class="container-fluid">
  ...
  <div class="col-sm-6">
    <h1 class="card-title"><?php echo ($roomuid == 0) ? $lang['addnewroom'] : $lang['editroom']; ?></h1>
  </div>
  <!-- Main content -->
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <label for="roomprice" class="col-sm-1 col-form-label">Rent</label>
              <div class="col-sm-5">
                <div class="input-group">
                  <div class="input-group-append">
                    <span class="input-group-text"><?php echo $options['currency_symbol']; ?></span>
                  </div>
                  <input type="text" class="form-control" id="roomprice" name="room_price" placeholder="" value="<?php echo ($roomuid == 0) ? set_value('room_price') : $roomdata['room_price']; ?>">
                </div>
          ...
          <div class="card-footer">
            ...
            <?php if ($roomuid == 0) { ?>
              <!-- <button type="submit" name="saveandnewroomant" class="btn btn-primary"><?php echo $lang['savenn']; ?></button> -->
            <?php } ?>
