                    ...
                    <table width="100%">
                        <tr>
                            <td class="title" style="width:65%">
                                ...
                                <?php } else { ?>
                                    <img src="<?php echo base_url(); ?>assets/usr_pics/<?php echo $options['app_logo']; ?>"
                            ...
                            <td>
                                ...
                                <?php echo $lang['date']; ?>:
                                <?php echo date('d M Y', strtotime($inv['invoice']['inv_created'])); ?><br>
                                <?php echo $lang['status']; ?>: <?php echo $inv['invoice']['inv_status']; ?><br>
                                <?php echo $lang['amount']; ?>: <?php echo $options['currency_symbol']; ?>
                                <?php echo $inv['invoice']['inv_total']; ?>
