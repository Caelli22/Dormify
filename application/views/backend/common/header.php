...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/backend/plugins/datatables-bs4/css/dataTables.bootstrap4.css">

    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/backend/plugins/datatables-responsive/css/responsive.bootstrap4.css">

    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/backend/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/backend/modern/vendor/fontawesome-free/css/all.min.css"
        type="text/css">
    <link rel="stylesheet"
    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="<?php echo $burl; ?>admin/dashboard">
            ...
            <?php if (isset($userdata) && $userdata['user_type'] == 'member') { ?>
                ...
                <li class="nav-item active">
                    <a class="nav-link <?php if ($cpage == 'dashboard')
                        echo "active"; ?>" href="<?php echo $burl; ?>admin/dashboard">
                ...
                <!-- My Profile -->
                <li class="nav-item">
                    <a href="<?php echo $burl; ?>admin/tenant/<?php echo $userdata['user_id']; ?>/tenantview" class="nav-link <?php if ($cpage == 'tenants')
                              echo "active"; ?>">
                ...
                <!-- Make Request-->
                <li class="nav-item">
                    <a href="<?php echo $burl; ?>admin/requestes" class="nav-link <?php if ($cpage == 'requestes')
                           echo "active"; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo $burl; ?>admin/allrequests" class="nav-link <?php if ($cpage == 'requestes')
                           echo "active"; ?>">
                        <i class="fas fa-plus"></i>
                        <span>All My Request</span></a>
                </li>

                <!-- Make Payment -->
                <!-- <li class="nav-item">
                    <a href="<?php echo $burl; ?>admin/makepayment"
                        class="nav-link <?php if ($cpage == 'payments')
                            echo "active"; ?>">
                ...
                <!-- Notices -->
                <li class="nav-item">
                    <a href="<?php echo $burl; ?>admin/notices" class="nav-link <?php if ($cpage == 'notices')
                           echo "active"; ?>">
                ...
                <!-- Events -->
                <li class="nav-item">
                    <a href="<?php echo $burl; ?>admin/events" class="nav-link <?php if ($cpage == 'events')
                           echo "active"; ?>">
            ...
            <?php if (isset($userdata) && $userdata['user_type'] == 'admin') { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed <?php if ($cpage == 'tenants' || $cpage == 'newtenant')
                        echo "active"; ?>" href="#" data-toggle="collapse" data-target="#collapseTenants"
                        aria-expanded="true" aria-controls="collapseTenants">
                        <i class="fas fa-users"></i>
                        <span>Tenant</span>
                    </a>
                    <div id="collapseTenants" class="collapse" aria-labelledby="headingPages"
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseExtraService" class="collapse" aria-labelledby="headingPages"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Service Options:</h6>
                            <a class="collapse-item" href="<?php echo $burl; ?>admin/extraservices">Manage Services</a>
                            <a class="collapse-item" href="<?php echo $burl; ?>admin/extraservices/add">New Service</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseInvoices" class="collapse" aria-labelledby="headingPages"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Invoices Options:</h6>
                            ...
                            <a class="collapse-item" href="<?php echo $burl; ?>admin/payments/add">Update Payments</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseNotices" class="collapse" aria-labelledby="headingPages"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <?php if (isset($userdata) && $userdata['user_type'] == 'super_admin') { ?>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseWebsite" class="collapse" aria-labelledby="headingPages"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- Nav Item - Configurations -->
            <li class="nav-item">
                <a href="<?php echo $burl; ?>admin/complaints" class="nav-link <?php if ($cpage == 'complaints')
                       echo "active"; ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                    ...
                                    <?php foreach ($branches as $branch) { ?>
                                        ...
                                        <a href="<?php echo $burl; ?>admin/selectbranch/<?php echo $branch['id']; ?>"
                                            class="dropdown-item"><?php echo $branch['branch_name']; ?>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $userdata['user_name']; ?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?php echo base_url(); ?>assets/usr_pics/<?php echo $userdata['profphoto']; ?>"
                                    alt="User Image">
                            </a>
                        ...
                        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">Select "Sign Out" below if you are ready to end your current
                                        session.</div>
