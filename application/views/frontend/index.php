...
<head>
  ...
  <meta name="description" content="DORMIFY is a complete all in one Residential Rental Management Software.">
  <meta name="author" content="Dormify Tecnhologies ">

  <title><?php echo $options['dhp_name']; ?> - Solutions</title>
...
<body id="page-top">
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; <?php echo $options['dhp_name']; ?> - Powered by Dormify</p>
    </div>
    <!-- /.container -->
  </footer>
